...
import { evaluateScenarioCliffShadow, evaluateScenarioCliffV5 } from "./scenario-cliff-shadow.mjs";
...
const evaluation = process.env.SCENARIO_CLIFF_V1_ONLY === "1" ? evaluateScenarioCliffShadow(records) : evaluateScenarioCliffV5(records);
