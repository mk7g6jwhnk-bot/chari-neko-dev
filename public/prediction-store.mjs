...
export function createSnapshot(payload,now=new Date()){
  ...
  snapshot.purchaseEligibility=prediction.purchaseEligibility||prediction.audit?.purchaseEligibility||{state:snapshot.noBet?"PURCHASE_BLOCKED":"PURCHASE_ALLOWED",canPurchase:!snapshot.noBet,noBet:snapshot.noBet,allowThick:!snapshot.noBet,allowFunding:!snapshot.noBet,showPurchasePanel:!snapshot.noBet};
  snapshot.predictionOutput.purchaseEligibility=snapshot.purchaseEligibility;
  snapshot.noBet=!snapshot.purchaseEligibility.canPurchase;
