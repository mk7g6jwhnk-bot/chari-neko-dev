...
function standardSelections(snapshot){const rows=(Array.isArray(snapshot?.betSelections)?snapshot.betSelections:[]).filter(b=>b?.category!=="REFERENCE");return rows.some(b=>b?.category==="MAIN")?rows:[];}
