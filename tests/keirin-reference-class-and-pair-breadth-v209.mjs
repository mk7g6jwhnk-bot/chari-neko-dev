...
try{
 ...
 const a=p.audit.chatSpecV1.secondPairBreadthAudit;assert.ok(a.recoveryCount>0);assert.ok(a.recoveries.every(x=>Number(String(x.pair).split("-")[0])===Number(a.primaryFirstFamilyNumber)));assert.equal(p.purchasePlan.length,10);
