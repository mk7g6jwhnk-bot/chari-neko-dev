...
function payload({blocked=false,weak=false,ev=.2}={}){
  const plan=blocked?[]:[{order:[1,2,3],betClass:"MAIN",probability:.25,expectedValueIndex:ev,naturalConvergenceScore:.9,originatingScenarioFamily:"LEAD-A",primaryBranch:"LEAD-A"}];
