...
const qualified=qualifyThickPredictionBets({betSelections:[{...allocated[0],category:"MAIN"},{...allocated[0],category:"COVER",order:[1,2,4],probability:.05,terminalScore:.3,naturalConvergenceScore:.2,globalRank:8,familyRank:4,pairRank:3,nodeConditionalProbability:.2,scenarioCoherence:.3,branchFit:.2}]});
