...
function buildTrace(t,riderMap,lines,branchMap){
  ...
  return{
    ...
    extraConditionDetails:Array.isArray(t.extraConditionDetails)?t.extraConditionDetails:[],
    extraConditionProbabilityMin:finite(t.extraConditionProbabilityMin)?Number(t.extraConditionProbabilityMin):null,
    extraConditionProbabilityMean:finite(t.extraConditionProbabilityMean)?Number(t.extraConditionProbabilityMean):null,
    extraConditionPenalty:finite(t.extraConditionPenalty)?Number(t.extraConditionPenalty):null,
