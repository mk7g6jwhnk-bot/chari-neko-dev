...
})}catch(e){meetings.push({...m,discoveryError:e.message})}}return jsonResponse(200,{ok:schedule.ok,date,meetings,diagnostics:{cookieNames:jar.names(),note:"公式内部リンク発見方式"},checkedAt:new Date().toISOString()})}catch(e){return jsonResponse(500,{ok:false,error:e.message})}};
